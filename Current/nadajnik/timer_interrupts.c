...
#define VIC_ADCCONVERTER_CHANNEL 18
...
/**********************************************/
void ADCInterrupts_Init(unsigned int uiPeriod, void (*ptrInterruptFunction)()){ // microseconds
	...
	VICIntEnable |= (0x1 << VIC_TIMER1_CHANNEL_NR);            // Enable Timer 1 interrupt channel 
	VICVectCntl1  = mIRQ_SLOT_ENABLE | VIC_ADCCONVERTER_CHANNEL;  // Enable Slot 1 and assign it to Timer 1 interrupt channel
	VICVectAddr1  =(unsigned long)Timer1IRQHandler; 	   // Set to Slot 1 Address of Interrupt Service Routine 
